        ...
        <div className='main'>
            <div className='mainDiv'>
                ...
                <ul>
                    ...
                    <li>This app simply scratches the surgace on what is possible with React.</li>
                    <li>We have tried to collect the very best resources for this app, and we have cited those here.</li>
